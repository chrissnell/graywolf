...
and `saucecodepro-nerd-font.css` for the face declarations. As shipped
in Phase 2 the `.css` file falls back to system monospace via `local()`
because the woff2 binaries have not been vendored yet.
