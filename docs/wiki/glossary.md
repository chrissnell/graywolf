...
| AGWPE | direwolf-compatible TCP TNC protocol. Subset implemented: `R/G/g/X/x/m/M/V/K/C/v/D/d/Y` (`C/v/D/d/Y` are connected mode, outbound only). | [`../../pkg/agw/protocol.go`](../../pkg/agw/protocol.go), [`../../pkg/agw/connected.go`](../../pkg/agw/connected.go), [`../handbook/agwpe.html`](../handbook/agwpe.html) |
