...
| Modulo-8 / Modulo-128 | LAPB sequence-number range. Mod-8 (default) uses 3-bit N(S)/N(R) and a 1-byte control field; mod-128 uses 7-bit fields and a 2-byte control field with a larger window. graywolf v1 ships mod-8 only; mod-128 negotiation lands in Phase 3. | [`../../pkg/ax25conn/control.go`](../../pkg/ax25conn/control.go), [`../../pkg/ax25conn/defaults.go`](../../pkg/ax25conn/defaults.go) |
